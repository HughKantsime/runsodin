...
function BedMismatchWarning({ modelId, printerId, modelsData, printersData }: { modelId: any; printerId: any; modelsData: any[]; printersData: any[] }) {
...
export function CreateJobModal({ isOpen, onClose, onSubmit, onSavePreset, modelsData, printersData }: { isOpen: boolean; onClose: () => void; onSubmit: (data: any) => void; onSavePreset?: (data: any) => void; modelsData?: any[]; printersData?: any[] }) {
...
export function RejectModal({ isOpen, onClose, onSubmit }: { isOpen: boolean; onClose: () => void; onSubmit: (reason: string) => void }) {
...
export function EditJobModal({ isOpen, onClose, onSubmit, job, printersData, modelsData }: { isOpen: boolean; onClose: () => void; onSubmit: (id: number, data: any) => void; job: any; printersData?: any[]; modelsData?: any[] }) {
  const [formData, setFormData] = useState({})
