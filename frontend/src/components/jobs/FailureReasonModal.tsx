...
export default function FailureReasonModal({ jobId, jobName, onSubmit, onClose, existingReason, existingNotes }: { jobId: number; jobName?: string; onSubmit: (jobId: number, reason: string, notes: string) => Promise<void>; onClose: () => void; existingReason?: string; existingNotes?: string }) {
