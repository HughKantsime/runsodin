...
export default function SpoolGrid({ spools, printers, sortBy, groupByPrinter, searchQuery, selectedSpools, onToggleSelect, onLoad, onUnload, onUse, onArchive, onEdit, onDry }: SpoolGridProps) {
