...
export default function QRScannerModal({ isOpen, onClose, onAssigned, preselectedPrinter = null, preselectedSlot = null }: { isOpen: boolean; onClose: () => void; onAssigned?: (result: any) => void; preselectedPrinter?: number | null; preselectedSlot?: number | null }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Scan Spool QR" size="md" mobileSheet={false}>
