import type { Printer, FilamentSlot } from '../types'

export const ONLINE_THRESHOLD_MS = 90_000

export function getShortName(slot: string | FilamentSlot | null): string {
...
export function isOnline(printer: Printer): boolean {
