  ...
  return (
    <div className="bg-farm-900 rounded-xl border border-farm-800 p-4">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm text-farm-400">{title}</span>
        {Icon && <Icon size={18} className="text-farm-500" />}
      </div>
  ...
  return (
    <div className="bg-farm-900 rounded-xl border border-farm-800 p-4">
      ...
      <div className="space-y-2">
        {data.map((item, i) => (
          <div key={item.id} className="flex items-center justify-between py-2 border-b border-farm-800 last:border-0">
            ...
            <div className="text-right">
              <div className={`font-medium ${ascending ? 'text-red-400' : 'text-print-400'}`}>
        ...
        {data.length === 0 && (
          <div className="text-center text-farm-500 py-4">No data yet</div>
        )}
      </div>
    </div>
  )
...
function PrinterStatsTable({ data }) {
  return (
    <div className="bg-farm-900 rounded-xl border border-farm-800 p-4">
      <div className="flex items-center gap-2 mb-4">
        <Printer size={18} className="text-farm-400" />
      ...
      <div className="space-y-2">
        {data.map((printer) => (
          <div key={printer.id} className="flex items-center justify-between py-2 border-b border-farm-800 last:border-0">
            ...
            <div className="text-right">
              <div className="font-medium">{printer.completed_jobs} jobs</div>
              <div className="text-xs text-farm-500">{printer.total_hours} hours</div>
            </div>
          </div>
        ))}
        {data.length === 0 && (
          <div className="text-center text-farm-500 py-4">No printer data</div>
        )}
      </div>
    </div>
  )
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-farm-400">Profitability and usage insights</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-farm-900 rounded-xl border border-farm-800 p-4">
          <div className="flex items-center gap-2 mb-4">
            <BarChart3 size={18} className="text-farm-400" />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center p-3 bg-farm-800 rounded-lg">
              <div className="text-2xl font-bold text-yellow-400">{summary.pending_jobs}</div>
