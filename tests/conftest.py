    ...
    if env_file.exists():
        for line in env_file.read_text().splitlines():
            ...
            if line and not line.startswith("#") and "=" in line:
                ...
                # .env.test is the canonical test target for this workspace.
                # Overwrite stale inherited env so test runs don't silently hit
                # an old staging/prod IP from a previous shell.
