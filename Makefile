.PHONY: build test test-contracts test-security test-e2e test-audit test-coverage scan verify bump release logs shell help
...
test-audit: ## Run the audit sweep and generate findings report
	pytest tests/test_e2e/test_audit_sweep.py tests/test_contracts/test_api_contract_sweep.py -v --tb=short; \
