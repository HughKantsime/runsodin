...
Transport: ws://printer_ip:3030/websocket (no auth)  # nosemgrep: javascript.lang.security.detect-insecure-websocket.detect-insecure-websocket -- by design — Elegoo SDCP printer protocol uses ws:// on LAN, no TLS in printer firmware
