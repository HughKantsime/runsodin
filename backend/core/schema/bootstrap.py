...
RAW_REQUIRED_COLUMNS = {
    ...
    "oidc_config": frozenset("id display_name client_id client_secret_encrypted tenant_id discovery_url scopes auto_create_users default_role is_enabled created_at updated_at".split()),
    ...
    "users": frozenset("id username email password_hash role is_active last_login created_at oidc_subject oidc_provider mfa_enabled mfa_secret quota_grams quota_hours quota_jobs quota_period theme_json group_id".split()),
